...
def main():
    ...
    st.header('Chat GPT', divider='rainbow')
    ...
    # Componente de entrada de texto multi-linha que expande conforme novas linhas são inseridas
    user_input = st.text_area("Digite sua msg:", key="user_input", height=100)
